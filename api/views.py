...
#endpoint is a location on the webserver that we are going to that are followed by a slash

#allows us to view and create a room
...
class JoinRoom(APIView):
    ...
    def post(self, request, format = None):
        ...
        if code != None:
            ...
            return Response({'Bad Request': 'Invalid Room Code Joined!'}, status = status.HTTP_400_BAD_REQUEST)
